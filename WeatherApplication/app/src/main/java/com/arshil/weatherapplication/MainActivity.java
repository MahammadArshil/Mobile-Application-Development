package com.arshil.weatherapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    class getWeather extends AsyncTask<String,Void, String>{
        ...
        protected void onPostExecute(String result){
            ...
            try{
                ...
                weatherInfo=weatherInfo.replace("temp","Temperature(in Kelvin)");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search=(Button) findViewById(R.id.btn_city_submit);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    if(city!=null){
                        url="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=96956b2bef90d810d9bed64bf58ce1b4";
                    }
                    else {
